doc(String, :slice, :[], <<-text)
      (Fixnum offset) => String or NilClass
...
doc(String, :slice, :[], <<-text)
      (Fixnum offset, Fixnum length) => String or NilClass
...
doc(String, :slice, :[], <<-text)  
      (Regexp pattern) => String or NilClass
...
doc(String, :slice, :[], <<-text)  
      (Regexp pattern, Fixnum offset) => String or NilClass
...
doc(String, :slice, :[], <<-text)
      (String string) => String or NilClass
