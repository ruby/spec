...
describe "String#dump" do
  ...
  it "returns a string with multi-byte UTF-8 characters replaced by \\uXXXX or \\u{XXXXX} or \\u{XXXXXX} notation with uppper-case hex digits" do
    [ [0200.chr('utf-8'), '"\u0080"'],
      [0201.chr('utf-8'), '"\u0081"'],
      [0202.chr('utf-8'), '"\u0082"'],
      [0203.chr('utf-8'), '"\u0083"'],
      ...
      [0xABC.chr('utf-8'), '"\u0ABC"'],
      [0xABCD.chr('utf-8'), '"\uABCD"'],
      [0xABCDE.chr('utf-8'), '"\u{ABCDE}"'],
      [0x10ABCD.chr('utf-8'), '"\u{10ABCD}"'],
    ].should be_computed_by(:dump)
  end
