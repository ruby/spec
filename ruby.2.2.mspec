# Configuration file for Ruby 2.2-compatible Ruby implementations.
#
...
class MSpecScript
  ...
  set :tags_patterns, [
                        [%r(language/),     'tags/2.2/language/'],
                        [%r(core/),         'tags/2.2/core/'],
                        [%r(command_line/), 'tags/2.2/command_line/'],
                        [/_spec.rb$/,       '_tags.txt']
                      ]
