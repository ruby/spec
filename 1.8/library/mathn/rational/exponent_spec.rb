...
describe "Rational#** when passed [Rational]" do
  ...
  it "returns Rational(1, 1) when self is 1" do
    (Rational(1,1) ** Rational(2, 3)).should == Rational(1,1)
    (Rational(1,1) ** Rational(-2, 3)).should == Rational(1,1)
    (Rational(1,1) ** Rational(2, -3)).should == Rational(1,1)
    (Rational(1,1) ** Rational(-2, -3)).should == Rational(1,1)
  end
  ...
  it "returns Rational(0, 1) when self is 0" do
    (Rational(0,1) ** Rational(2, 3)).should == Rational(0,1)
    (Rational(0,1) ** Rational(-2, 3)).should == Rational(0,1)
    (Rational(0,1) ** Rational(2, -3)).should == Rational(0,1)
    (Rational(0,1) ** Rational(-2, -3)).should == Rational(0,1)
  end
  ...
  it "returns a Complex number when self is negative" do
    (Rational(-1,2) ** Rational(2, 3)).should be_close(Complex(-0.314980262473718, 0.545561817985861), TOLERANCE)
    (Rational(-1,2) ** Rational(-2, 3)).should be_close(Complex(-0.793700525984099, -1.3747296369986), TOLERANCE)
    (Rational(-1,2) ** Rational(2, -3)).should be_close(Complex(-0.793700525984099, -1.3747296369986), TOLERANCE)
  end
end
...
describe "Rational#** when passed [Integer]" do
  ...
  it "returns Rational(1, 1) when the passed argument is 0" do
    (Rational(3, 4) ** 0).should == Rational(1, 1)
    (Rational(-3, 4) ** 0).should == Rational(1, 1)
    (Rational(3, -4) ** 0).should == Rational(1, 1)

    (Rational(bignum_value, 4) ** 0).should == Rational(1, 1)
    (Rational(3, -bignum_value) ** 0).should == Rational(1, 1)
  end
end

describe "Rational#** when passed [Float]" do
  it "returns self converted to Float and raised to the passed argument" do
    (Rational(3, 1) ** 3.0).should == 27.0
