# Configuration file for Ruby 2.3-compatible Ruby implementations.
#
...
class MSpecScript
  ...
  set :tags_patterns, [
                        [%r(language/),     'tags/2.3/language/'],
                        [%r(core/),         'tags/2.3/core/'],
                        [%r(command_line/), 'tags/2.3/command_line/'],
                        [/_spec.rb$/,       '_tags.txt']
                      ]
